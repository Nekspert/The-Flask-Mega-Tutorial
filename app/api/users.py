...
def get_users():
    ...
    return User.to_collection_dict(sa.select(User), page=page, per_page=per_page,
...
def get_followers(id):
    ...
    return User.to_collection_dict(user.followers.select(), page=page, per_page=per_page,
...
def get_following(id):
    ...
    return User.to_collection_dict(user.following.select(), page=page, per_page=per_page,
                                   endpoint="api.get_following", id=id)
